        ...
        <div class="max-w-6xl mx-auto fade-in">
            ...
            <div class="mb-12">
                <div class="flex items-center mb-6">
                    ...
                    <div>
                        <h1 class="text-5xl font-bold text-white neon-text mb-2">Créer une race</h1>
                        <p class="text-gray-400 text-xl">Définissez une nouvelle espèce pour vos univers</p>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        function setupForm() {
            ...
            form.addEventListener('submit', function(e) {
                ...
                Object.keys(newRace).forEach(key => {
                    if (newRace[key] === '' || newRace[key] === null || newRace[key] === undefined) {
                        delete newRace[key];
                    }
                });
