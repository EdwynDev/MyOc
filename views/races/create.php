        ...
        imageField.innerHTML = `
            ...
            <div class="space-y-3">
                <div>
                    ...
                    <input type="url" id="${imageId}_url" name="images[${imageCounter}][url]" class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500" placeholder="https://exemple.com/image.jpg">
                </div>
