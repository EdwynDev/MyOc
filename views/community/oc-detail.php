...
<div class="fade-in">
    <div class="max-w-6xl mx-auto">
        ...
        <div class="glass-dark rounded-3xl p-12 border border-blue-500/30 mb-12">
            <div class="flex items-start space-x-6">
                ...
                <div>
                    <h3 class="text-xl font-bold text-blue-400 mb-3">Publications permanentes</h3>
                    <p class="text-gray-300 leading-relaxed">
                        Les OCs partagés dans la communauté sont permanents et ne peuvent plus être modifiés ou supprimés. 
